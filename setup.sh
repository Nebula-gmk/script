...
wget https://raw.githubusercontent.com/Nebula-gmk/script/main/cf.sh && chmod +x cf.sh && ./cf.sh
#install ssh ovpn
wget https://raw.githubusercontent.com/Nebula-gmk/script/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
wget https://raw.githubusercontent.com/Nebula-gmk/script/main/sstp.sh && chmod +x sstp.sh && screen -S sstp ./sstp.sh
#install ssr
...
#install v2ray
wget http://raw.githubusercontent.com/Nebula-gmk/script/main/ins-vt.sh && chmod +x ins-vt.sh && screen -S v2ray ./ins-vt.sh
#install L2TP
...
wget -O /etc/set.sh "https://raw.githubusercontent.comNebula-gmk/script/main/set.sh"
chmod +x /etc/set.sh
history -c
echo "1.2" > /home/ver
clear
